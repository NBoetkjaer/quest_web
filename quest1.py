...
<p class="flow-text light">
  ...
  Da webserveren benytter cookies til at gemme opgaven, skal vi importere Session fra requests modulet.<br>
  Skriv koden nedenfor, som det første i dit nye program:
</p>
<p class="codeblock flow-text">from requests.sessions import Session</p>

<p class="flow-text light">
  Nu kan vi lave et Python 'dictonary' som indeholder det data vi skal sende. Et 'dictionary' er en meget fleksibel datastruktur, der samler navne og værdier.
...
print(data['Hint']) # Eller man kan printe et enketlt af felterne i dictionary'et.
</p>
